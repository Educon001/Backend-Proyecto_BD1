...
export async function createPresenta(req: Request, res: Response) {
    ...
    let presenta = new Presenta(parseInt(req.body.codevacuna), parseInt(req.body.codesintoma));
    try {
        console.time(
...
export async function updatePresenta(req: Request, res: Response) {
    ...
    let presenta = new Presenta(parseInt(presentaCodeVacuna), parseInt(presentaCodeSintoma));
    try {

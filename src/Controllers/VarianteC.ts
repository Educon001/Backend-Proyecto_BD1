...
export async function createVariante(req: Request, res: Response) {
   ...
   let variante = new Variante(req.body.denom_oms, req.body.linaje,
       parseInt(req.body.origin_year), parseInt(req.body.origin_month),
       req.body.clasification, parseInt(req.body.code_pais));
   try {

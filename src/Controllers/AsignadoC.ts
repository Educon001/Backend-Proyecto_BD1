...
export async function createAsignado(req: Request, res: Response) {
    ...
    let asignado = new Asignado(req.body.idpersonalsalud, parseInt(req.body.codecentrosalud), new Date(req.body.dateasignado));
    try {
        console.time(
...
export async function updateAsignado(req: Request, res: Response) {
    ...
    let asignado = new Asignado(asignadoIdPersonalSalud, parseInt(asignadoCodeCentroSalud), new Date(asignadoDateAsignado));
    try {

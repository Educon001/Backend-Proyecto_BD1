...
export async function createConsiste(req: Request, res: Response) {
    ...
    let consiste = new Consiste(parseInt(req.body.codetratamiento), parseInt(req.body.codemedicamento), parseInt(req.body.cantdays),
...
export async function updateConsiste(req: Request, res: Response) {
    ...
    let consiste = new Consiste(parseInt(consisteTratamiento), parseInt(consisteMedicamento), parseInt(req.body.cantdays), req.body.frecuency, parseInt(req.body.dosis));
    try {
